...
API_ATTR_PM25_CF1: Final = 'pm2_5_cf_1'
API_ATTR_PM25_AQI: Final = 'pm2_5_atm_aqi'
API_ATTR_PM25_AQI_RAW: Final = 'pm2_5_atm_aqi_raw'
API_ATTR_HUMIDITY: Final = 'humidity'
API_ATTR_TEMP_F: Final = 'temp_f'
API_ATTR_PRESSURE: Final = 'pressure'

JSON_PROPERTIES: Final = [
    API_ATTR_PM25_CF1, API_ATTR_PM1, API_ATTR_PM25, API_ATTR_PM10,
    API_ATTR_HUMIDITY, API_ATTR_TEMP_F, API_ATTR_PRESSURE,
]
